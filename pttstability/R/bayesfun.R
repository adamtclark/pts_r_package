...
#' @param neff Should effective sample size be used to scale likelihood? Defaults to FALSE.
...
likelihood0 <- function(param, y=y, parseparam=parseparam0, N=1e3, detfun=detfun0, edmdat=NULL, neff=FALSE, lowerbound=(-Inf)) {
