...
#'                                 edmdat = list(E=Euse, theta=tuse), procfun = procfun0,
#'                                 dotraceback = TRUE, fulltraceback = TRUE)
#'
#' #plot filter output
...
#'
#' par(mfrow=c(2,2))
#' hist(exp(smp_detfun0[,1]), main="det. function", xlab="obs", breaks = 20)
#' abline(v=exp(pars_true$obs), col=2)
#' hist(exp(smp_detfun0[,2]), main="det. function", xlab="proc", breaks = 20)
#' abline(v=sd_abs, col=2)
#'
#' hist(exp(smp_EDM[,1]), main="EDM function", xlab="obs", breaks = 20)
#' abline(v=exp(pars_true$obs), col=2)
